  ...
  >
    <template v-slot:top>
      <v-toolbar flat color="white">
        <v-toolbar-title>Examine</v-toolbar-title>
    ...
    <v-card>
        ...
        <v-card-text>
          <v-container>
            ...
            <v-row>
              <v-text-field v-if="editedItem.supervisorname == null" label="Supervisor" value="Not assigned to any supervisor" readonly></v-text-field>
              <v-text-field v-else label="Supervisor" v-model="editedItem.supervisorname" readonly></v-text-field>
            </v-row>
          </v-container>
...
<script>
  export default {
    ...
    // REPLACED
      initialize() {
          axios.get('api/v1/user/examined')
